...
class aravisCamera(GenICam):
    ...
    ArgInfo = makeArgInfo(__init__,
        ...
        CLASS   = Choice('Camera class for custom commands',
                         ["AVT_Manta_G235B","AVT_Manta_G609B","AVT_Manta_G125B","AVT_Mako_G234C","AVT_Manta_G235C","AVT_Prosilica_GC655C","AVT_Mako_1_52","Prosilica_GC","AVT_Manta_1_44","AVT_Manta_G125C","AVT_Mako_G125C","AVT_Mako_G125B","AVT_Mako_G507B","AVT_Manta_G895B","AVT_Prosilica_GT5120"]),
